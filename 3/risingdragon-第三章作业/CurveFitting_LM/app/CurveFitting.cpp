...
public:
    ...
    virtual void ComputeResidual() override
    {
     ...
     //residual_(0) = abc(0)*x_*x_ + abc(1)*x_ + abc(2)  - y_;  // 作业构建二次函数残差
    }
...
int main()
{
    ...
    for (int i = 0; i < N; ++i) {
        ...
        // 观测 y
        double y = std::exp( a*x*x + b*x + c ) + n;    //原来的指数函数模型；
       //  double y =  a*x*x + b*x + c + n;    //作业中的二次函数
